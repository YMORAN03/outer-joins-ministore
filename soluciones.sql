...
SELECT distinct productos.producto_id, productos.nombre, productos.categoria
FROM productos
left join ventas
...
SELECT productos.producto_id, productos.nombre, ventas.venta_id, ventas.fecha_venta , ventas.producto_id 
FROM productos
